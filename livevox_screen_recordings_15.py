...
fh = logging.handlers.TimedRotatingFileHandler(
    "/home/callproc/logs/LV_ScreenRec_15.log", when="midnight", backupCount=14
)
...
def get_call_recordings():
    ...
    global filename
    filename = datetime.strftime(yesterday, "%Y%m%d") + "_15_SCREEN_RECORDINGS.zip"
    file_path = "/home/callproc/LVScreenRecordings/"
