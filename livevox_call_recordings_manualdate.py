...
fh = logging.FileHandler(
    "/home/callproc/logs/" + "LV_CR.log." + entered_filename[0:4] + '-' + entered_filename[4:6] + '-' + entered_filename[6:8]
)
...
def yesterdays_log_to_S3():
    ...
    log_filename = "LV_CR.log." + entered_filename[0:4] + '-' + entered_filename[4:6] + '-' + entered_filename[6:8]
